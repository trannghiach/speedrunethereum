...
const deployedContracts = {
  31337: {
    ...
    RateController: {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 1226,
    },
  },
  11155111: {
    DEX: {
      address: "0xF1434f208856024eE2218DAD6E73684ca032d855",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9963080,
    },
    MyUSD: {
      address: "0xcd0B2bbf0F8b23b5973573c0705F84917787BC33",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9963079,
    },
    MyUSDEngine: {
      address: "0xf882527440D222ae1DC3923EA9fb28d6bC1dAF56",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9963083,
    },
    MyUSDStaking: {
      address: "0x7Ac9715FefcFCC36612D22A5cee001ab7C28cc95",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9963082,
    },
    Oracle: {
      address: "0xc7E1644c46546DB350fCd2a0e20eA4B90d07c753",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9963081,
    },
    RateController: {
      address: "0xF2b5EDDE883f683cAF22462F4dfa0bE640ee79cb",
      abi: [
        {
          inputs: [
            {
